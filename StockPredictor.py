...
def stock_prediction(company, start_date, end_date):


    stock_start = dt.datetime(start_date)
    stock_end = dt.datetime(end_date)
    ...
    plt.title(f'{company} Price Predictor')
    plt.xlabel('Time')
    plt.ylabel(f'{company} stock')
    plt.legend()
    plt.show()
